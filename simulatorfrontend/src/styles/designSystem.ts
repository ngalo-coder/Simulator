...
export const cssVariables = `
  :root {
    ...
    /* Medical Colors */
    --color-medical-light: ${designSystem.colors.medical.light};
    --color-medical-primary: ${designSystem.colors.medical.primary};
    --color-medical-dark: ${designSystem.colors.medical.dark};
    --color-medical-accent: ${designSystem.colors.medical.accent};
    
    /* Component Styles */
    --card-background: ${designSystem.components.card.backgroundColor};
    --card-border: ${designSystem.components.card.border};
    --card-border-radius: ${designSystem.components.card.borderRadius};
    --card-padding: ${designSystem.components.card.padding};
    --card-shadow: ${designSystem.components.card.shadow};
    --card-hover-shadow: ${designSystem.components.card.hoverShadow};
    
    /* Animation */
    --transition-fast: ${designSystem.animation.transition.fast};
    --transition-normal: ${designSystem.animation.transition.normal};
    --transition-slow: ${designSystem.animation.transition.slow};
  }
`;
