...
import { createToken } from './SimulatorBackend/src/services/authService.js';
import User from './SimulatorBackend/src/models/UserModel.js';
import ContributedCase from './SimulatorBackend/src/models/ContributedCaseModel.js';
import CaseReview from './SimulatorBackend/src/models/CaseReviewModel.js';
...
async function testReviewWorkflow() {
  ...
  // Generate tokens
  const adminToken = createToken(adminUser._id.toString());
  const educatorToken = createToken(educatorUser._id.toString());
